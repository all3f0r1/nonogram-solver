...
impl ConstraintExtractor {
    ...
    fn extract_constraint_zones(
        ...
        for row in 0..grid_height {
            ...
            let constraints = Self::extract_row_constraints(&gray_img, y, margin_left, cell_size)?;
        ...
        for col in 0..grid_width {
            ...
            let constraints = Self::extract_col_constraints(&gray_img, x, margin_top, cell_size)?;
